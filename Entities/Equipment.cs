    ...
    public static class EquipmentFactory
    {
        ...
        public static Equipment CreateVampireBlade()
        {
            var blade = new Equipment("Vampire Blade", EquipmentSlot.Weapon, EquipmentRarity.Epic)
            {
                ...
                LifeStealBonus = 0.15f, // 15% lifesteal
                RequiredLevel = 10
            };
            return blade;
        }
        ...
        public static Equipment CreateSpeedBoots()
        {
            var boots = new Equipment("Boots of Swiftness", EquipmentSlot.Boots, EquipmentRarity.Rare)
            {
                ...
                SpeedBonus = 50f,
                DodgeChanceBonus = 0.05f, // 5% dodge
                RequiredLevel = 5
            };
            return boots;
        }
        ...
        public static Equipment CreateCriticalRing()
        {
            var ring = new Equipment("Ring of Precision", EquipmentSlot.Accessory1, EquipmentRarity.Rare)
            {
                ...
                CritMultiplierBonus = 0.5f, // +0.5x crit damage
                RequiredLevel = 8
            };
            return ring;
        }
        ...
        public static Equipment CreateRegenerationAmulet()
        {
            var amulet = new Equipment("Amulet of Vitality", EquipmentSlot.Accessory2, EquipmentRarity.Uncommon)
            {
                ...
                MaxHealthBonus = 30,
                HealthRegenBonus = 2f, // 2 HP per second
                RequiredLevel = 3
            };
            return amulet;
        }
        ...
        public static Equipment CreateLegendarySword()
        {
            var sword = new Equipment("Excalibur", EquipmentSlot.Weapon, EquipmentRarity.Legendary)
            {
                ...
                CritMultiplierBonus = 1f, // 3x total crit damage
                RequiredLevel = 20
            };
            return sword;
        }
